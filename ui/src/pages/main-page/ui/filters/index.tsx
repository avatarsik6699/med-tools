...
import { useStack } from "../../../../shared/hooks/use-stack";
	...
	return (
		...
		>
			<Combobox.Target>
				<Button
					rightSection={
						<Chevrone size={18} isRotate={combobox.dropdownOpened} />
					}
					color="dark.5"
			...
			>
				<Box w="max-content" ref={ref}>
					<Combobox.Search
						...
						rightSection={
							!pages.isInitialPage && <Kbd size="xs">Backspace</Kbd>
						}
						leftSection={
						...
						placeholder={
							pages.isInitialPage ? "Что ищем?" : `${pages.last().label}...`
						}
						onKeyDown={keyboard}
					/>
					<Combobox.Options
